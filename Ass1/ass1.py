...
def auxBFS(initial, final):
    ...
    if ans == final:
        print(f"BFS checked {_bfs} states to reach the final state.")
    else:
        print(f"Not possible to reach the final state by BFS. {_bfs} states checked.")
...
def auxDFS(initial, final):
    ...
    if ans == final:
        print(f"DFS checked {_dfs} states to reach the final state.")
    else:
        print(f"Not possible to reach the final state by DFS. {_dfs} states checked.")
...
if __name__ == '__main__':
    ...
    #call the bfs function and time it
    startBFS = stopwatch()
    auxBFS(initial, final)
    endBFS = stopwatch()

    #call the dfs function and time it
    startDFS = stopwatch()
    auxDFS(initial, final)
    endDFS = stopwatch()

    #print out the time taken
    print(f'\n\nBFS took {round(endBFS - startBFS, 3)} seconds.')
    print(f'DFS took {round(endDFS - startDFS, 3)} seconds.')